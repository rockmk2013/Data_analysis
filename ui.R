                  ...
                  navlistPanel(
                    ...
                    tabPanel("Agent Schedule Optimization",
                             tabsetPanel(
                               ...
                               tabPanel("Monday",
                                        downloadButton("downloadData_1", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Tuesday",
                                        downloadButton("downloadData_2", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Wednesday",
                                        downloadButton("downloadData_3", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Thursday",
                                        downloadButton("downloadData_4", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Friday",
                                        downloadButton("downloadData_5", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Saturday",
                                        downloadButton("downloadData_6", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Sunday",
                                        downloadButton("downloadData_7", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
