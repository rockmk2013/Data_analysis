...
shinyUI(fluidPage(theme = shinytheme("journal"),
                  ...
                  navlistPanel(
                    ...
                    tabPanel("Trend Analysis",
                             tabsetPanel(
                               tabPanel("Hourly",
                                        ...
                                        HTML('<br>'),
                                        h4("請輸入門檻人數(小時)"),
                                        textInput("threshold_hourly","門檻人數"),
                                        actionButton("goButton_hourly", label = "Go!",width=150),
                                        textOutput("threshold_hourly_console"),
                                        HTML('<br>'),
                                        dataTableOutput("hourly_threshold_table_holiday"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                                        dataTableOutput("hourly_threshold_table_time"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Daily",
                                        ...
                                        HTML('<br>'),
                                        h4("請輸入門檻人數(天)"),
                                        textInput("threshold_daily","門檻人數"),
                                        actionButton("goButton_daily", label = "Go!",width=150),
                                        textOutput("threshold_daily_console"),
                                        HTML('<br>'),
                                        dataTableOutput("daily_threshold_table_holiday"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                                        HTML('<center><h2>Revenue vs InstoreTraffic</h2></center>'),
                               ...
                               tabPanel("Monthly",
                                        ...
                                        dataTableOutput("Month_of_year_overview"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                               ...
                               tabPanel("Compare",
                                        downloadButton("downloadData_Compare", "DownloadGraph!"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                                        h4("請輸入門檻人數(小時)"),
                                        textInput("threshold_compare","門檻人數"),
                                        h4("請選擇比較區間資料(小時)"),
                                        HTML('<br>'),
                                        fileInput("compare_data_hourly", "Choose CSV File",
                                                  accept = c(
                                                    "text/csv",
                                                    "text/comma-separated-values,text/plain",
                                                    ".csv")
                                        ),
                                        actionButton("goButton_compare", label = "Go!",width=150),
                                        textOutput("threshold_compare_console"),
                                        HTML('<br>'),
                                        HTML('<center><h2>Revenue vs InstoreTraffic</h2></center>'),
                                        plotOutput("revenue_compare"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                                        HTML('<center><h2>Transaction vs InstoreTraffic</h2></center>'),
                                        plotOutput("transaction_compare"),
                                        HTML('<br>'),
                                        HTML('<br>'),
                                        HTML('<center><h2>ACV vs InstoreTraffic</h2></center>'),
                                        plotOutput("acv_compare"),
                                        HTML('<br>'),
                                        HTML('<br>')
                               )
                             )
                    ...
                    tabPanel("Customer Journey",
                             ...
                             HTML('<br>'),
                             HTML('<br>'),
                             HTML('<center><h2>Customer river</h2></center>'),
